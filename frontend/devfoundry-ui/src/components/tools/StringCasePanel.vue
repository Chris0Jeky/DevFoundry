  ...
  <div class="tool-panel">
    ...
    <div class="panel-content">
      <div class="option">
        ...
        <select v-model="targetCase" class="select">
      ...
      <div class="form-section">
        ...
        <textarea
          ...
          class="textarea"
          rows="6"
          placeholder="Enter text to convert (e.g., myVariableName, my-variable-name, etc.)"
        ></textarea>
      </div>
...
async function runTool() {
  ...
  try {
    const result = await toolsStore.runTool({
      ...
      parameters: { targetCase: targetCase.value }
    })
